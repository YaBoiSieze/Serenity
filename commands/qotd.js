...
message.channel.send("**Question of the day**", {files: ["https://pbs.twimg.com/profile_images/589118083500904448/eu-RVGFT_400x400.jpg"]});

let facts = ['	If you didn’t have to sleep What would you do with the extra time?',
...
'	If you were forced to relive one 10-minute block of your lIfe again and again for all eternity What 10 minutes of your lIfe would you choose? '];
	...
	message.channel.send(facts[fact]).then(sentMessage => {
message.channel.send('<@&574623496265793556>');
});
}
module.exports.help = {
  name:"qotd"
